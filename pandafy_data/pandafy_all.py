...
def pandafy_all(super_folder='../../'):
    ...
    add_image_to_h5_radar.add_image_to_h5_radar(save_name=super_folder+'pandafied_data/pandafied_h5_radar_img.csv',data_folder=super_folder+'AHN2_5m/',encoder_file_name=super_folder+'results/pooling_narrow_experiment_AHN2_5m_SOBELCOMP/pool_1_encoder',history_file=super_folder+'results/pooling_narrow_experiment_AHN2_5m_SOBELCOMP/pool_1_history.json',pandas_data_file_name=super_folder+'pandafied_data/pandafied_h5_radar.csv',file=super_folder+'pandafied_data/lat_lon_to_filename.csv',saved_file_list=super_folder+'pandafied_data/saved_file_list.json')
