...
/////////////////////////////////////////////////////////////		
	...
	myfile << "Filename,X,Y,Longitude,Latitude,Elevation,KNMIX,KNMIY,KNMILONG,KNMILAT" << endl;
	//Schrijft per regel:
	for(i=0; i<NMAX; i++){
		for(j=0; j<MMAX; j++){
			...
			myfile << geit[KNMI_Y_temp][KNMI_X_temp].KNMI_LONGI << "," << geit[KNMI_Y_temp][KNMI_X_temp].KNMI_LATI << endl;
		}
	}
