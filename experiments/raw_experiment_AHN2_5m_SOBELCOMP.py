...
if __name__ == '__main__':
    ...
    parameters = {}
    parameters['experiment_name'] = 'raw_experiment_AHN2_5m_SOBELCOMP'
    parameters['experiment_type'] = 'raw_filtering'
    parameters['encoder_type'] = 'raw'
    ...
    if run: 
        parameters['train_part'] = 50#10000
        parameters['test_part'] = 10#2000
        parameters['val_part'] = 10#2000
    else:
    ...
    parameters['loss'] = 'mean_squared_error'#'binary_crossentropy'
    #parameters['filter'] = 'identity'
    parameters['filter'] = 'sobel_components'
    ...
    parameters['deep_pooling_vars'] = [1,2,5]
    parameters['filtering_vars'] = [4,8,20]
