...
if __name__ == '__main__':
    ...
    parameters = {}
    parameters['experiment_name'] = 'dimensions_experiment_MNIST'
    ...
    parameters['data_folder'] = '../../AHN2_5m/'#'../../../../data/s0315435/AHN2_5m/'
    if run: 
    ...
    parameters['results_folder'] = '../../results/dimensions_experiment_MNIST/'
