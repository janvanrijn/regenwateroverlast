...
if __name__ == '__main__':
    ...
    parameters = {}
    parameters['experiment_name'] = 'Surajits_ae_experiment_AHN2_5m_SOBEL'
    ...
    parameters['optimizer'] = 'adadelta'#'adam'
    parameters['loss'] = 'binary_crossentropy'#'mse'
    ...
    parameters['pooling_factor_vars'] = [2,4,10]
