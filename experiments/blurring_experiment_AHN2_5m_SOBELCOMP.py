...
if __name__ == '__main__':
    ...
    parameters = {}
    parameters['experiment_name'] = 'blurring_experiment_AHN2_5m_SOBELCOMP'
    parameters['experiment_type'] = 'blurring'
    parameters['encoder_type'] = 'blur'
    ...
    if run: 
        parameters['train_part'] = 50
        parameters['test_part'] = 10
        parameters['val_part'] = 10
    else:
    ...
    parameters['blurring_vars'] = [4,8,20,40]
