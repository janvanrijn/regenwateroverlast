...
if __name__ == '__main__':
    ...
    parameters = {}
    parameters['experiment_name'] = 'pooling_narrow_experiment_AHN2_5m_test_SOBEL2'
    ...
    parameters['train_part'] = 500#5000
    parameters['test_part'] = 100#1000
    parameters['val_part'] = 100#1000
    if run: 
